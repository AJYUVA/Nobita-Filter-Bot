...
* Check [info.py]([https://github.com/NobiDeveloper/Nobita-Filter-Bot/blob/master/info.py](https://github.com/AJYUVA/Nobita-Filter-Bot)) for more optional variables
